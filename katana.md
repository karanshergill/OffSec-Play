```
> rustscan -b 1000 -u 5000 -r 0-65535 -a 192.168.224.83 -- -Pn
```
```
.----. .-. .-. .----..---.  .----. .---.   .--.  .-. .-.
| {}  }| { } |{ {__ {_   _}{ {__  /  ___} / {} \ |  `| |
...
Open 192.168.224.83:21
Open 192.168.224.83:22
Open 192.168.224.83:80
Open 192.168.224.83:7080
Open 192.168.224.83:8088
Open 192.168.224.83:8715
[~] Starting Script(s)
[>] Script to be run Some("nmap -vvv -p {{port}} {{ip}}")

Host discovery disabled (-Pn). All addresses will be marked 'up' and scan times may be slower.
[~] Starting Nmap 7.94 ( https://nmap.org ) at 2023-10-19 09:29 EDT
...
Scanning 192.168.224.83 [6 ports]
Discovered open port 21/tcp on 192.168.224.83
Discovered open port 22/tcp on 192.168.224.83
Discovered open port 80/tcp on 192.168.224.83
Discovered open port 7080/tcp on 192.168.224.83
Discovered open port 8088/tcp on 192.168.224.83
Discovered open port 8715/tcp on 192.168.224.83
Completed Connect Scan at 09:29, 0.18s elapsed (6 total ports)
Nmap scan report for 192.168.224.83
Host is up, received user-set (0.17s latency).
Scanned at 2023-10-19 09:29:57 EDT for 0s
...
```
> rustscan -u 5000 -p 21,22,80,7080,8088,8715 -a 192.168.224.83 -- -Pn -sCV
```
```
.----. .-. .-. .----..---.  .----. .---.   .--.  .-. .-.
| {}  }| { } |{ {__ {_   _}{ {__  /  ___} / {} \ |  `| |
...
Host discovery disabled (-Pn). All addresses will be marked 'up' and scan times may be slower.
[~] Starting Nmap 7.94 ( https://nmap.org ) at 2023-10-19 09:31 EDT
...
Discovered open port 8715/tcp on 192.168.224.83
Discovered open port 7080/tcp on 192.168.224.83
Completed Connect Scan at 09:31, 0.17s elapsed (6 total ports)
Initiating Service scan at 09:31
Scanning 6 services on 192.168.224.83
Completed Service scan at 09:31, 27.79s elapsed (6 services on 1 host)
NSE: Script scanning 192.168.224.83.
NSE: Starting runlevel 1 (of 3) scan.
Initiating NSE at 09:31
Completed NSE at 09:32, 13.12s elapsed
NSE: Starting runlevel 2 (of 3) scan.
Initiating NSE at 09:32
Completed NSE at 09:32, 3.76s elapsed
NSE: Starting runlevel 3 (of 3) scan.
Initiating NSE at 09:32
Completed NSE at 09:32, 0.00s elapsed
Nmap scan report for 192.168.224.83
Host is up, received user-set (0.18s latency).
Scanned at 2023-10-19 09:31:25 EDT for 45s
...
|_-----END CERTIFICATE-----
|_http-title: Did not follow redirect to https://192.168.224.83:7080/
...
TCP 80 - HTTP
![image](https://github.com/karanshergill/OffSec-Play/assets/83878909/223edbba-4542-451d-b4ce-26ea820a1f59)
